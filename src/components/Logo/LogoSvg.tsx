...
const LogoSvg = () => {
  return (
    <svg
      ...
      // viewBox="0 0 500 500"
    >
      {/* <circle path="cls-1" cx="250" cy="250" r="250" fill="#0581fd" />
      <circle path="cls-2" cx="250" cy="250" r="95.89" fill="#A9A9A9" />
      <circle path="cls-3" cx="163.82" cy="102.66" r="56.91" fill="#e1e7f9" />
      <circle path="cls-3" cx="94.16" cy="203.73" r="35.16" fill="black" /> */}
      <circle path="cls-1" cx="250" cy="250" r="250" fill="#0581fd" />
      <circle path="cls-2" cx="250" cy="250" r="95.89" fill="#A9A9A9" />
      <circle path="cls-3" cx="163.82" cy="102.66" r="56.91" fill="#e1e7f9" />
      <circle path="cls-3" cx="94.16" cy="203.73" r="35.16" fill="black" />
